        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center h-16">
            ...
            <Link to="/" className="flex items-center space-x-2">
              <span className="text-2xl font-bold text-green-600">ZAPP</span>
            </Link>
      ...
      <footer className="bg-gray-800 text-white py-6">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {/* Company Info */}
            <div>
              <h3 className="text-lg font-semibold mb-4">ZAPP</h3>
              <p className="text-gray-300 mb-4">
                Your trusted online grocery store for the Caribbean and Africa.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link to="/affiliate" className="text-gray-300 hover:text-white transition-colors">
                    Affiliate Program
                  </Link>
                </li>
              </ul>
          ...
          {/* Bottom Footer */}
          <div className="mt-6 pt-4 border-t border-gray-700 text-sm text-gray-400 flex flex-col md:flex-row justify-between">
            <p>&copy; {new Date().getFullYear()} ZAPP. All rights reserved.</p>
